...
class Halaman2Activity : AppCompatActivity() {
    ...
    private val gMapsUrl = "https://maps.google.com/maps?gloc:"
    ...
    // Moved initLayout outside of onCreate
    ...
    private fun initListener() {
        binding.layoutLocation.root.setOnClickListener {
            ...
            // Ensure Intent is imported
            val mapIntent = Intent(Intent.ACTION_VIEW, gMapsIntentUri)
            mapIntent.setPackage(packageMaps) // Corrected how setPackage is called
